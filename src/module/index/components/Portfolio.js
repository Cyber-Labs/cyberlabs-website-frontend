              ...
              <li
                ...
                <a className="ajax-link" href="comingSoon">
                  <div className="grid-hover">
                    ...
                    <p>ISMites gear up for the test of their attention on 26th January, after the
                      fancy puzzle posted on the event page made everyone scartch their heads.</p>
                  </div>
                </a>
              </li>
              <li
                ...
                <a className="ajax-link" href="comingSoon">
                  <div className="grid-hover">
                    ...
                    <p>Amusing humans with ONE more perspective they missed out upon, the movie
                      series is up to fire-up the love game with technology and scientific thinking.</p>
                  </div>
                </a>
              </li>
              <li
              ...
              <li
                ...
                <a className="ajax-link" href="comingSoon">
                  <div className="grid-hover">
                    ...
                    <p>Demo time for the members- from engaging dustbins, remote alerting systems to
                      basic portal framework: members cross V1 of what was incepted.</p>
                  </div>
                </a>
              </li>
            </div>
              ...
              <li
                ...
                <a className="ajax-link" href="comingSoon">
                  <div className="grid-hover">
                    ...
                    <p>The digiBoard is the concept to an engaging notice board engaging with simple
                      intuitive colors.</p>
                  </div>
                </a>
              </li>
