                    ...
                    <div className="row">
                        <div className="col-lg-12 col-md-12 col-sm-12" style={{marginBottom: "50px"}}>
                            <div className="col-lg-4 col-md-4 col-sm-2 col-xs-12">
                                <img src="assets/img/kalyan_sir.jpg" height="230" className="mx-auto center-block circular-img" style={{borderRadius: "50%"}} />
                                <center>
                            ...
                            <div className="col-lg-4 col-md-4 col-sm-2 col-xs-12">
                                <img src="assets/img/large/mohit.png" height="230" className="mx-auto center-block circular-img" style={{borderRadius: "50%"}} />
                                <center>
                            ...
                            <div className="col-lg-4 col-md-4 col-sm-2 col-xs-12">
                                <img src="assets/img/jsec.jpg" height="230" className="mx-auto center-block circular-img" style={{borderRadius: "50%"}} />
                                <center>
                        ...
                        <div className="col-lg-12 col-md-12 col-sm-12" style={{marginBottom: "50px"}}>
                           <div className="col-lg-12  col-md-12 col-sm-12 col-xs-12">
                               <img src="assets/img/large/prabodhS.jpg" height="230" className="mx-auto center-block circular-img" style={{borderRadius: "50%"}} />
                               <center>
