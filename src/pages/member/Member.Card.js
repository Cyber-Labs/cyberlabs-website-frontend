      ...
      <div className="member-card">
		...
		info.img
          ? <ProgressiveImage
              ...
              placeholder={`/assets/opImg/memberProfile/${info.img}`}>
              {(src, loading) => <img
                src={src}
                alt="member"
                height="250"
        ...
        <div className="member-details">
          <ul className="member-social-links">
			...
			info.links.github && 
			<li className="member-social-icon">
              <a href={info.links.github} rel="noopener noreferrer" target="_blank">
			...
			info.links.linkedin && 
			<li className="member-social-icon">
              <a href={info.links.linkedin} rel="noopener noreferrer" target="_blank">
			...
			info.links.others && 
			<li className="member-social-icon">
              <a href={info.links.others} rel="noopener noreferrer" target="_blank">
