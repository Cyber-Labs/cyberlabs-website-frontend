        ...
        <div className="box effect82">
          <div className="columns">
            <div className="column1">
                <img src={images? `assets/img/project/${images}`: "https://images.pexels.com/photos/255379/pexels-photo-255379.jpeg"} style={{"borderRadius":"0","margin":"0"}} width="100%" height="270px" alt ="Name of project" />
            </div>
            <div className = "column-2">
                <div className="name" ><h1>{project}</h1></div>
                <div className="about">
                </div>
                <hr width="50%"  color="orange"/>    
                <div className="url">
                <div className="icon1"><a href={links.github} target="_blank" rel="noopener noreferrer">
